...
namespace MyApiApp.Migrations
{
    ...
    [Migration("20250711193807_AddOwningGroupAndRiskFK")]
    partial class AddOwningGroupAndRiskFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABPCourse.Demo1.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ABPCourse.Demo1.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Risk", b =>
                {
                    ...
                    b.Property<Guid>("ControlEffectivenessId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("InherentRiskRatingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsInheritFromRiskStatement")
                        .HasColumnType("bit");
                    ...
                    b.Property<Guid>("ResidualRiskRatingId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ABPCourse.Demo1.Products.Product", b =>
                {
                    b.HasOne("ABPCourse.Demo1.Categories.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Risk", b =>
                {
                    ...
                    b.HasOne("MyApiApp.Domain.RiskCategory", "RiskCategory")
                        .WithMany()
                    ...
                    b.HasOne("MyApiApp.Domain.RiskStage", "RiskStage")
                        .WithMany()
                        .HasForeignKey("RiskStageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
